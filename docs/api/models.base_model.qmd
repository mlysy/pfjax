# models.base_model { #pfjax.models.base_model }
...
| Name | Description |
| --- | --- |
| [BaseModel](#pfjax.models.base_model.BaseModel) | Base model for particle filters. |

### BaseModel { #pfjax.models.base_model.BaseModel }

```python
models.base_model.BaseModel(bootstrap)
```
...
| Name | Description |
| --- | --- |
| [init_lpdf](#pfjax.models.base_model.BaseModel.init_lpdf) | Calculate log-density of the default proposal distribution |
| [init_sample](#pfjax.models.base_model.BaseModel.init_sample) | Sample from default initial proposal distribution |
| [pf_init](#pfjax.models.base_model.BaseModel.pf_init) | Initial step of particle filter. |
| [pf_step](#pfjax.models.base_model.BaseModel.pf_step) | Particle filter update. |
| [step_lpdf](#pfjax.models.base_model.BaseModel.step_lpdf) | Calculate log-density of the default proposal distribution |
| [step_sample](#pfjax.models.base_model.BaseModel.step_sample) | Sample from default proposal distribution |

##### init_lpdf { #pfjax.models.base_model.BaseModel.init_lpdf }

```python
models.base_model.BaseModel.init_lpdf(x_init, y_init, theta)
```
...
##### init_sample { #pfjax.models.base_model.BaseModel.init_sample }

```python
models.base_model.BaseModel.init_sample(key, y_init, theta)
```
...
##### pf_init { #pfjax.models.base_model.BaseModel.pf_init }

```python
models.base_model.BaseModel.pf_init(key, y_init, theta)
```
...
##### pf_step { #pfjax.models.base_model.BaseModel.pf_step }

```python
models.base_model.BaseModel.pf_step(key, x_prev, y_curr, theta)
```
...
##### step_lpdf { #pfjax.models.base_model.BaseModel.step_lpdf }

```python
models.base_model.BaseModel.step_lpdf(x_curr, x_prev, y_curr, theta)
```
...
##### step_sample { #pfjax.models.base_model.BaseModel.step_sample }

```python
models.base_model.BaseModel.step_sample(key, x_prev, y_curr, theta)
```
