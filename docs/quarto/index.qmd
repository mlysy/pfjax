...
- A [comparison of gradient and hessian algorithms](gradient_comparisons.qmd) based on particle filters, which in turn are used for conducting parameter inference.

- An example of parameter inference using [stochastic optimization](stochopt_tutorial.qmd).

- An example of parameter inference using [Markov chain Monte Carlo](mcmc_tutorial.qmd).
